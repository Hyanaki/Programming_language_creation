...
public class XGDParser extends DebugParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "ID", "INT", "EXPONENT", "FLOAT", "COMMENT", "WS", "ESC_SEQ", "STRING", "CHAR", "HEX_DIGIT", "UNICODE_ESC", "OCTAL_ESC", "'-'", "'Transform'", "';'", "'type'", "'='", "'nom'", "'Translation'", "'{'", "','", "'}'", "'Rotation'", "'Scale'", "'Group'", "'Geometry'", "'Cone'", "'Material'", "':'", "'Sphere'", "'Cylinder'", "'Cube'", "'Teapot'", "'Tetrahedron'", "'Torus'", "'Ka'", "'Kd'", "'Ks'", "'d'", "'Ns'", "'textureScale'", "'textureFile'", "'<'", "'>'", "'/'", "'Root'", "'('", "')'", "'*'", "'+'"
    };
    ...
    public static final String[] ruleNames = new String[] {
        "invalidRule", "sphere", "translation", "geometry", "cone", "transform", 
        "group", "tetrahedron", "couleur", "torus", "nombre", "syntaxe", 
        "scale", "root", "animation", "teapot", "cylinder", "operande", 
        "rotation", "expMult", "expre", "expPlus", "cube"
    };
    ...
    // C:\\Users\\quent\\Desktop\\TPcin\\TP2\\XGD.g:367:1: animation returns [String result] : (xp= nombre | expr= expre );
    public final String animation() throws RecognitionException {
        ...
        try {
            // C:\\Users\\quent\\Desktop\\TPcin\\TP2\\XGD.g:367:35: (xp= nombre | expr= expre )
            int alt27=2;
            ...
            switch (alt27) {
                ...
                case 2 :
                    ...
                    // C:\\Users\\quent\\Desktop\\TPcin\\TP2\\XGD.g:367:116: expr= expre
                    {
                    dbg.location(367,121);
                    pushFollow(FOLLOW_expre_in_animation2043);
                    expr=expre();

                    state._fsp--;

                    dbg.location(367,128);
    ...
    public static final BitSet FOLLOW_23_in_translation626 = new BitSet(new long[]{0x00040000000100B0L});
    public static final BitSet FOLLOW_animation_in_translation629 = new BitSet(new long[]{0x0000000001000000L});
    public static final BitSet FOLLOW_24_in_translation641 = new BitSet(new long[]{0x00040000000100B0L});
    public static final BitSet FOLLOW_animation_in_translation644 = new BitSet(new long[]{0x0000000001000000L});
    public static final BitSet FOLLOW_24_in_translation656 = new BitSet(new long[]{0x00040000000100B0L});
    ...
    public static final BitSet FOLLOW_23_in_rotation683 = new BitSet(new long[]{0x00040000000100B0L});
    public static final BitSet FOLLOW_animation_in_rotation686 = new BitSet(new long[]{0x0000000001000000L});
    public static final BitSet FOLLOW_24_in_rotation698 = new BitSet(new long[]{0x00040000000100B0L});
    public static final BitSet FOLLOW_animation_in_rotation701 = new BitSet(new long[]{0x0000000001000000L});
    public static final BitSet FOLLOW_24_in_rotation713 = new BitSet(new long[]{0x00040000000100B0L});
    public static final BitSet FOLLOW_animation_in_rotation716 = new BitSet(new long[]{0x0000000001000000L});
    public static final BitSet FOLLOW_24_in_rotation728 = new BitSet(new long[]{0x00040000000100B0L});
    ...
    public static final BitSet FOLLOW_23_in_scale755 = new BitSet(new long[]{0x00040000000100B0L});
    public static final BitSet FOLLOW_animation_in_scale764 = new BitSet(new long[]{0x0000000001000000L});
    public static final BitSet FOLLOW_24_in_scale776 = new BitSet(new long[]{0x00040000000100B0L});
    public static final BitSet FOLLOW_animation_in_scale779 = new BitSet(new long[]{0x0000000001000000L});
    public static final BitSet FOLLOW_24_in_scale791 = new BitSet(new long[]{0x00040000000100B0L});
    ...
    public static final BitSet FOLLOW_expre_in_animation2043 = new BitSet(new long[]{0x0000000000000002L});
